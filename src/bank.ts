...
export const QUESTION_BANK: BankQuestion[] = [
  ...
  { q: "Mis spordialal kasutatakse reketit ja sulgpallisulge?", o: ["Sulgpall", "Jalgpall", "Ujumine", "Kergejõustik"], c: 0, f: "Sulgpallis on sulg kiiruselt kiireim liikuv objekt spordis.", cat: "Sport", dif: "lihtne" },
  ...
  { q: "Millisel spordialal peetakse tiitlivõitlusi poksikinnastega?", o: ["Poks", "Ujumine", "Golf", "Male"], c: 0, f: "Poksis peetakse tiitlivõitlusi tavaliselt 12 raundis.", cat: "Sport", dif: "lihtne" },
  { q: "Millise spordialaga on seotud Wimbledoni turniir?", o: ["Tennis", "Jalgpall", "Korvpall", "Rugby"], c: 0, f: "Wimbledon on ainus Grand Slam, mida mängitakse muruväljakul.", cat: "Sport", dif: "lihtne" },
  ...
  { q: "Mitu setti tuleb meeste Grand Slami finaalis viiest võita?", o: ["3", "2", "4", "1"], c: 0, f: "Naiste turniiridel mängitakse enamasti kolmest settist, kus vaja on kaks võitu.", cat: "Sport", dif: "keskmine" },
  ...
  { q: "Milline riik võõrustas 1930. aastal esimesi FIFA jalgpalli maailmameistrivõistlusi?", o: ["Uruguay", "Itaalia", "Prantsusmaa", "Brasiilia"], c: 0, f: "Uruguay võitis ka ise selle esimese turniiri.", cat: "Sport", dif: "raske" },
  { q: "Mitu mängijat mängib korraga väljakul rugby unioni meeskonnas?", o: ["15", "13", "11", "7"], c: 0, f: "Rugby liiga (league) versioonis mängitakse 13 mängijaga.", cat: "Sport", dif: "raske" },
  ...
  { q: "Kelle juhtimisel jõudsid eurooplased 1492. aastal esimest korda Ameerikasse?", o: ["Christoph Kolumbus", "Vasco da Gama", "Ferdinand Magalhães", "James Cook"], c: 0, f: "Kolumbus arvas algul, et jõudis Indiasse.", cat: "Ajalugu", dif: "lihtne" },
  ...
  { q: "Millisel ajastul toimusid suured ristisõjad Pühale Maale?", o: ["11.-13. sajand", "8.-9. sajand", "15.-16. sajand", "5.-6. sajand"], c: 0, f: "Esimene ristisõda algas aastal 1096.", cat: "Ajalugu", dif: "keskmine" },
  ...
  { q: "Mitu mandrit Maal tavapäraselt eristatakse?", o: ["7", "5", "6", "8"], c: 0, f: "Mõnes käsitluses loetakse Euraasiat üheks mandriks, mitte kaheks.", cat: "Geograafia", dif: "lihtne" },
  ...
  { q: "Milline linn on tuntud maailma kõrgeima pealinnana merepinnast?", o: ["La Paz", "Quito", "Bogotá", "Thimphu"], c: 0, f: "La Paz asub Boliivias, üle 3600 meetri merepinnast.", cat: "Geograafia", dif: "raske" },
  ...
  { q: "Kelle nimega seostatakse kuulus lugu langevast õunast ja gravitatsiooniseadusest?", o: ["Isaac Newton", "Albert Einstein", "Galileo Galilei", "Charles Darwin"], c: 0, f: "Newton avaldas oma teooria 1687. aastal.", cat: "Teadus", dif: "lihtne" },
  ...
  { q: "Kes kehastas Jack Sparrow't filmisarjas \"Kariibi mere piraadid\"?", o: ["Johnny Depp", "Orlando Bloom", "Geoffrey Rush", "Keira Knightley"], c: 0, f: "Tegelaskuju inspireeris osaliselt Keith Richards.", cat: "Filmid ja muusika", dif: "keskmine" },
  ...
  { q: "Milline helilooja kirjutas oma 9. sümfoonia, olles ise juba peaaegu täiesti kurt?", o: ["Ludwig van Beethoven", "Wolfgang Amadeus Mozart", "Johann Sebastian Bach", "Franz Schubert"], c: 0, f: "Sümfoonia esiettekanne oli 1824. aastal Viinis.", cat: "Filmid ja muusika", dif: "raske" },
  ...
  { q: "Milline veekogu piirneb Eestiga põhjast?", o: ["Soome laht", "Läänemeri", "Riia laht", "Peipsi järv"], c: 0, f: "Soome lahe teisel kaldal asub Soome.", cat: "Eesti", dif: "lihtne" },
  ...
  { q: "Ligikaudu kui kõrge on Eesti kõrgeim tipp Suur Munamägi?", o: ["317 m", "250 m", "400 m", "180 m"], c: 0, f: "Suur Munamägi asub Võrumaal.", cat: "Eesti", dif: "keskmine" },
  ...
  { q: "Millist nime kannab periood, mil Eesti liikus laulupidude toel rahumeelselt iseseisvuse taastamiseni?", o: ["Laulev revolutsioon", "Vaikiv ajastu", "Sula periood", "Ärkamisaeg"], c: 0, f: "Periood sai alguse 1988. aastal.", cat: "Eesti", dif: "raske" },
  ...
  { q: "Mitu kombitsat on kaheksajalal?", o: ["8", "6", "10", "4"], c: 0, f: "Kaheksajalgadel on väga arenenud närvisüsteem.", cat: "Loomad ja loodus", dif: "keskmine" },
  ...
  { q: "Milline loom kannab oma poegi kõhukotis?", o: ["Känguru", "Rebane", "Ilves", "Karu"], c: 0, f: "Kängurupoeg elab taskus mitu kuud pärast sündi.", cat: "Loomad ja loodus", dif: "keskmine" },
  ...
  { q: "Milline on ainus imetajaliik, kes suudab tõeliselt lennata?", o: ["Nahkhiir", "Lendorav", "Lendkala", "Lendkonn"], c: 0, f: "Teised \"lendavad\" loomad tegelikult liuglevad.", cat: "Loomad ja loodus", dif: "raske" },
  { q: "Millist looma nimetatakse \"elavaks fossiiliks\", kuna tema kehaehitus pole sadu miljoneid aastaid muutunud?", o: ["Hoburaudkrabi", "Krokodill", "Kilpkonn", "Hai"], c: 0, f: "Hoburaudkrabid on eksisteerinud juba enne dinosauruste teket.", cat: "Loomad ja loodus", dif: "raske" },
  ...
  { q: "Millise mao mürki peetakse LD50 järgi maailma kõige mürgisemaks?", o: ["Sisemaa taipan", "Kobra", "Mamba", "Rästik"], c: 0, f: "Sisemaa taipan elab Austraalia kõrbealadel ja väldib inimasustust.", cat: "Loomad ja loodus", dif: "raske" },
];
